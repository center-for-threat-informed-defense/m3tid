...
* Recover: Organizations can validate their backup and recovery plans by testing themselves against realistic adversary tradecraft using the Adversary Emulation Library [#f10]_ or Micro Emulation Plans [#f11]_. These are particularly valuable for testing recovery in ransomware scenarios
...
.. [#f10] https://mitre-engenuity.org/cybersecurity/center-for-threat-informed-defense/adversary-emulation-library/
.. [#f11] https://mitre-engenuity.org/cybersecurity/center-for-threat-informed-defense/our-work/micro-emulation-plans/
